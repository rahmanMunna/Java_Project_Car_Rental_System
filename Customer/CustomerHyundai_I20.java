...
public class CustomerHyundai_I20 extends JFrame implements ActionListener{
    ...
    public CustomerHyundai_I20(Car i20,CustomerLoginInformation Cus)
    {
        this.Cus=Cus;
        this.car=i20;
        ...
        setname = new JTextField(i20.getBrandName());
        setModel = new JTextField(i20.getModel());
        setCarID = new JTextField(i20.getCarID());
        setColor = new JTextField(i20.getColor());
        setPrice = new JTextField(i20.getPrice()+" TK");
        setStatus = new JTextField(i20.getStatus());
        ...
        image = new ImageIcon(getClass().getResource("/Image/Hyundai_I20.jfif"));
        imageLabel = new JLabel(image);
        imageLabel.setBounds(400,90,image.getIconWidth(),image.getIconHeight());
