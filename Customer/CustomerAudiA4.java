...
public class CustomerAudiA4 extends JFrame implements ActionListener{
    ...
    public CustomerAudiA4(Car A4,CustomerLoginInformation Cus)
    {
       this.Cus=Cus;
        this.car=A4;
        ...
        setname = new JTextField(A4.getBrandName());
        setModel = new JTextField(A4.getModel());
        setCarID = new JTextField(A4.getCarID());
        setColor = new JTextField(A4.getColor());
        setPrice = new JTextField(A4.getPrice()+" TK");
        setStatus = new JTextField(A4.getStatus());
        ...
        image = new ImageIcon(getClass().getResource("/Image/AudiA4.jfif"));
