...
public class CustomerCarList extends JFrame implements ActionListener{
   ...
   protected Cursor cursor;
        ...
        Car IX2 = new BMW("BMW","BMW_IX2","03","BLUE",700,"Available");
        Car i20 = new Hyundai("HYUNDAI","HYUNDAI_I20","05","WHITE",720,"Available"); 
  ...
  public  CustomerCarList(CustomerLoginInformation Cus)
   {
	   this.Cus=Cus;
       //car= new Car[number];
...
public void  actionPerformed(ActionEvent e)
  {
      if(e.getSource()==btn1)
      {
         new CustomerToyotaCamry(camry,Cus);
         this.setVisible(false);
      }
      else if(e.getSource()==btn2)
      {
         new CustomerToyotaCorolla(Corolla,Cus);
         this.setVisible(false);
          
      }
      else if(e.getSource()==btn3)
      {
         new CustomerBMW_IX2(IX2,Cus);
         this.setVisible(false);
          
      }
      else if(e.getSource()==btn4)
      {
         new CustomerAudiA4(A4,Cus);
         this.setVisible(false);
          
      }
      else if(e.getSource()==btn5)
      {
         new CustomerHyundai_I20(i20,Cus);
         this.setVisible(false);
      }
      else if(e.getSource()==btn6)
      {
         new CustomerNissanGTR(GTR,Cus);
         this.setVisible(false);
