...
public class CustomerToyotaCamry extends JFrame implements ActionListener{
    ...
    public CustomerToyotaCamry(Car camry,CustomerLoginInformation Cus)
    {
        this.Cus=Cus;
        this.car=camry;
        ...
        setname = new JTextField(camry.getBrandName());
        setModel = new JTextField(camry.getModel());
        setCarID = new JTextField(camry.getCarID());
        setColor = new JTextField(camry.getColor());
        setPrice = new JTextField(camry.getPrice()+" TK");
        setStatus = new JTextField(camry.getStatus());
        ...
        image = new ImageIcon(getClass().getResource("/Image/ToyotaCamry.jfif"));
        imageLabel = new JLabel(image);
        imageLabel.setBounds(410,100,image.getIconWidth(),image.getIconHeight());
